...
public interface DDScannerRestService {
    ...
    @GET("v2_5/user.achievements.get")
    ...
    @GET("v2_5/countries.get")
    Call<ResponseBody> getListCountries();

    @Multipart
    @POST("v2_5/divespot.review.add")
    ...
    @Multipart
    @POST("v2_5/divespot.review.update")
    ...
    @GET("v2_5/user.notifications.personal.get")
    ...
    @POST("v2_5/user.legacy_divecenter.invite")
    ...
    @POST("v2_5/user.divecenter.invite")
    ...
    @GET("v2_5/user.legacy_divecenter.profile.get")
