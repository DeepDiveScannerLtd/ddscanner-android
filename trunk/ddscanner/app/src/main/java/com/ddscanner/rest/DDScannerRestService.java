...
public interface DDScannerRestService {
    ...
    @GET("v2_7/user.achievements.get")
    ...
    @GET("v2_7/countries.get")
    Call<ResponseBody> getListCountries();

    @Multipart
    @POST("v2_7/divespot.review.add")
    ...
    @Multipart
    @POST("v2_7/divespot.review.update")
    ...
    @GET("v2_7/user.notifications.personal.get")
    ...
    @POST("v2_7/user.legacy_divecenter.invite")
    ...
    @POST("v2_7/user.divecenter.invite")
    ...
    @GET("v2_7/user.legacy_divecenter.profile.get")
